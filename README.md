# Ygh.Rental.Management.System.API
...
```
cd existing_repo
git remote add origin https://gitlab.com/hunglmhe171165/ygh.rental.management.system.api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/hunglmhe171165/ygh.rental.management.system.api/-/settings/integrations)
